...
const steps = [
  ...
  },
  {
    ...
    description:
      "Debt-free? Keep going! Use that money to build 6 months of emergency fund to stay protected from major surprises without new debt.",
...
const tips = [
  {
    id: "04",
    title: "Invest 10% of Your Household Income in Retirement",
    description:
      "This is where you begin regularly investing 10% of your gross income for retirement. Because if you're still working at 67, it should be because you want to, not because you have to.",
  },
  {
    id: "05",
    title: "Save for Your Children's College Fund",
    description:
      "Next, it's time to save for your children's college expenses (You can use that money to start a business for them if they dont want to go to go to college).",
  },
  {
    id: "06",
    title: "Pay Off Your Home Mortgage",
    description:
...
const Basics = () => {
  return (
    <div className="max-w-7xl mx-auto py-12 px-6 mt-25">
      {/* Title */}
