	...
	<div class="eltdf-menu-area <?php echo esc_attr($menu_area_position_class); ?>">
		...
		<?php endif; ?>
			...
			<div class="eltdf-vertical-align-containers">
				...
				<?php if ($menu_area_position === 'center' || $menu_area_position === 'right') : ?>
...
undefinedundefined<div class="fxs-toast-description fxs-portal-title" id="_weave_e_814"><!--_weave_cstart_602-->Unable to add Temporary Access Pass. - Converged UserCredentialPolicy does not allow creating or updating this authentication method. AuthMethodType [TemporaryAccessPass].<!--_weave_cend_602--></div>